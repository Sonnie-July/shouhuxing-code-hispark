...
void *AppDemoAht20(char *param)
{
    ...
    float temp,humi;
    /* init oled i2c */
    IoTGpioInit(HI_IO_NAME_GPIO_13); /* GPIO13 */
    IoSetFunc(HI_IO_NAME_GPIO_13, HI_I2C_SDA_SCL); /* GPIO13,  SDA */
    IoTGpioInit(HI_IO_NAME_GPIO_14); /* GPIO 14 */
    IoSetFunc(HI_IO_NAME_GPIO_14, HI_I2C_SDA_SCL); /* GPIO14  SCL */
