...
public class AmqpClient {
    ...
    private static String accessKey = "LTAI5tFVCadFYVqrg4HjWfZq";
    private static String accessSecret = "CAibOaY8l8t4Mv1ZBmPbhq4KFSSLVc";
    private static String consumerGroupId = "m3sJZ065vnBORHesQEJW000100";

    //iotInstanceId：实例ID。若是2021年07月30日之前（不含当日）开通的公共实例，请填空字符串。
    private static String iotInstanceId = "iot-06z00a8mvpwryro";

    //控制台服务端订阅中消费组状态页客户端ID一栏将显示clientId参数。
    //建议使用机器UUID、MAC地址、IP等唯一标识等作为clientId。便于您区分识别不同的客户端。
    private static String clientId = "haisi1";

    //${YourHost}为接入域名，请参见AMQP客户端接入说明文档。
    private static String host = "iot-06z00a8mvpwryro.amqp.iothub.aliyuncs.com";
